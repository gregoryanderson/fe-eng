...
export default function EnhancedTable(props) {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = props.invoiceItems.map((n) => n.id);
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={props.invoiceItems.length}
            />
            <TableBody>
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      ...
                      role="checkbox"
                      aria-checked={isinvoiceItemselected}
                      tabIndex={-1}
                      key={row.name}
                      selected={isinvoiceItemselected}
                    >
                      <TableCell padding="checkbox">
                        <Checkbox
                          checked={isinvoiceItemselected}
        ...
        <TablePagination
          ...
          component="div"
          count={props.invoiceItems.length}
